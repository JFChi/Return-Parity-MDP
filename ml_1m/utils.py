...
def mf_with_bias(rating_file, env_object_path, config, data_path, lr=1e-2, l2_factor=1e-2, max_step=1000, train_rate=0.95, max_stop_count=30):
...
def get_envobjects(ratingfile, data_path, boundary_rating=None, emb_dim=8, lr=1e-2, l2_factor=1e-2, max_step=2000, train_rate=0.95, max_stop_count=30):
